...
### (4) DreamVideo
Our DreamVideo is based on fine-tuned ModelScopeT2V. Base model weights, adapter weights, and more cases will be released, so stay tuned.  
...
Tips:
- For some subjects, setting `use_mask_diffusion` to `True` may achieve better results. Make sure to put the binary masks of the subject into the subfolder ''masks'', and you can use [SAM](https://github.com/facebookresearch/segment-anything) to obtain these masks.
...
Tips:
- Try increasing training steps or increasing the learning rate for single video motion customization to get better results.
...
Tips:
- We do not use DDIM Inversion by default. However, for single video motion customization, we encourage you to try setting `inverse_noise_strength` to `0~0.5` to better align the training video. For multi-video motion customization, we recommend setting `inverse_noise_strength` to 0.
...
<center>
  <tr>
    <td ><center>
      <image  height="260" src="https://img.alicdn.com/imgextra/i3/O1CN01sYfJvj1ESLZKaSYjL_!!6000000000350-1-tps-320-180.gif"></image>	
    </center></td>
    <td ><center>
      <image height="260" src="https://img.alicdn.com/imgextra/i4/O1CN01z95HUN1xqlOQofSiz_!!6000000006495-1-tps-320-180.gif"></image>	
    </center></td>
  </tr>
  <tr>
    <td ><center>
...
<center>
  <tr>
    <td ><center>
      <image  height="260" src="https://img.alicdn.com/imgextra/i2/O1CN01QrEAPM1PvcewRM6ar_!!6000000001903-1-tps-320-180.gif"></image>	
    </center></td>
    <td ><center>
      <image height="260" src="https://img.alicdn.com/imgextra/i4/O1CN01CykVZD1wKsCQaOGwc_!!6000000006290-1-tps-320-180.gif"></image>	
    </center></td>
  </tr>
  <tr>
    <td ><center>
...
<center>
  <tr>
    <td ><center>
      <image  height="260" src="https://img.alicdn.com/imgextra/i4/O1CN01aRPa5j20nVQEuD63m_!!6000000006894-1-tps-320-180.gif"></image>	
    </center></td>
    <td ><center>
      <image height="260" src="https://img.alicdn.com/imgextra/i3/O1CN01oCs8ZT1RJj7Up6zhN_!!6000000002091-1-tps-320-180.gif"></image>	
    </center></td>
  </tr>
  <tr>
    <td ><center>
...
<center>
  <tr>
    <td ><center>
      <image  height="260" src="https://img.alicdn.com/imgextra/i4/O1CN01gFGTMO1zSbjellb6W_!!6000000006713-1-tps-320-180.gif"></image>	
    </center></td>
    <td ><center>
      <image height="260" src="https://img.alicdn.com/imgextra/i1/O1CN01pCZ49I1q2ekgpggyW_!!6000000005438-1-tps-320-180.gif"></image>	
    </center></td>
  </tr>
  <tr>
    <td ><center>
